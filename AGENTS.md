...
Leggi integralmente `docs/Hub_Fatture_MASTER_PLAN.md` prima di agire: è la fonte canonica per prodotto, UX, brand, architettura, modello commerciale, test, distribuzione e roadmap.
