...
| Schema candidato     | `018_legacy_webhook_history.sql` verificato localmente                                  |
...
| ----------------------------------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| Audit trasversale del codice                                                  | Chiuso localmente; RC-01-RC-51 chiusi, nessun finding P0-P3 aperto | [Audit del release candidate](../audits/release-candidate-review.md), gate canonico locale |
