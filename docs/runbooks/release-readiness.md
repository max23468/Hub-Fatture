...
| ----------------------------------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| Audit trasversale del codice                                                  | Chiuso localmente; RC-01-RC-55 chiusi, nessun finding P0-P3 aperto | [Audit del release candidate](../audits/release-candidate-review.md), gate canonico locale |
