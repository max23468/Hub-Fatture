...
8. In **Documenti → Importa file ufficiale**, selezionare il documento e il tipo corretto, quindi importare ogni file. L’XML deve coincidere con l’hash approvato; file non riconosciuti vengono rifiutati.
