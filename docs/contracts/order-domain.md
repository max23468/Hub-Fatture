...
- Quando la sorgente riconduce l’acquirente all’anagrafica con l’identificativo fiscale già presente nella preparazione aperta di un solo ordine, ogni importazione ordini sposta automaticamente ordine e preparazione dal cliente provvisorio senza modificarne la fotografia; il cliente provvisorio orfano viene rimosso.
