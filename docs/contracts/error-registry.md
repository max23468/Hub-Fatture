...
| `FISCAL_PROFILE_CONFIRMATION_REQUIRED` | VALIDATION permanente | no               | confermare la provenienza degli XML   |
| `FISCAL_PROFILE_SOURCE_INVALID`        | VALIDATION permanente | no               | usare gli XML SdI accettati corretti  |
| `INVALID_CONTENT_TYPE`                 | VALIDATION permanente | no               | inviare il formato previsto           |
| `METHOD_NOT_ALLOWED`                   | VALIDATION permanente | no               | usare un metodo previsto dalla route  |
