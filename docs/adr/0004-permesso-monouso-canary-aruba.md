...
Il canary copre una TD01 reale. La TD04 viene qualificata con fixture e `dryRun=true`, ma il
...
canary non deve restare alcun permesso valido né una modalità ordinaria di invio attiva.
