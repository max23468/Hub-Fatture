...
3. usa la sessione Aruba già aperta nel browser, lasciando login e challenge all’utente, e dalla Home apre autonomamente `Fatture inviate` tramite la UI visibile;
