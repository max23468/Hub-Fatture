...
- il bucket occupava `1692627` byte rispetto alla soglia prudenziale di 15 GB; un override effimero della soglia ha prodotto un solo allarme e il successivo rientro, con stato finale sano e `2` messaggi pubblicati e `2` consegnati riletti alle `2026-08-11T22:20:00Z`;
- con worker arrestato e soglia bucket superata, il monitor ha aggregato entrambi i guasti nello stesso stato; una seconda esecuzione identica non ha duplicato l’avviso, il riavvio del worker ha prodotto il solo rientro e OCI ha registrato `2` messaggi pubblicati e `2` consegnati alle `2026-08-11T22:28:00Z`;
