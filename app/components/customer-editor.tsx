...
type EditableAddress = NonNullable<EditableCustomer["billingAddress"]>;
type EditableTaxIdentifier = NonNullable<EditableCustomer["taxIdentifiers"]>[number];

function CustomerIdentityFields({ customer }: { customer: EditableCustomer }) {
...
function CustomerAddressFields({ address }: { address: EditableAddress }) {
...
function CustomerTaxFields({ identifiers }: { identifiers: EditableTaxIdentifier[] }) {
  return (
    <fieldset className="form-section">
  ...
  return (
    <details className="card section-gap preparation-disclosure" id="dati-destinatario" open>
      ...
      <Form method="post" className="customer-form" onChange={onDirty}>
        ...
        <CustomerIdentityFields customer={customer} />
        <CustomerAddressFields address={address} />
        <CustomerTaxFields identifiers={identifiers} />
