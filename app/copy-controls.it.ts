...
export const controlsCopy = {
  ...
  candidateComparison: "Confronto con i candidati",
  candidateLocalTotal: "Totale ordini",
  candidateDifference: "Differenza",
  candidateSignals: {
    explicitReference: "Riferimento ordine",
    sameDay: "Stesso giorno",
    nearDate: "Data compatibile",
    total: "Totale coincidente",
    recipient: "Destinatario",
    taxId: "Identificativo fiscale",
    address: "Indirizzo",
  } as Record<string, string>,
  signalConfirmed: "Confermato",
  signalMissing: "Non coincidente o assente",
  ...
  emptyFiltered: "Nessun controllo corrisponde ai filtri",
  emptyFilteredHelp: "Modifica i filtri o la ricerca per vedere altri controlli.",
  projectionCurrent: (value: string) => `Coda aggiornata ${value}`,
  projectionStale: (value: string) => `Coda non aggiornata: ultimo aggiornamento ${value}`,
  projectionUnavailable: "Aggiornamento della coda non ancora disponibile",
