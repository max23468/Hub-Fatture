...
export const auditActionLabels = {
  ...
  ARUBA_API_CANARY_AUTHORIZED: "Invio pilota Aruba autorizzato",
  ARUBA_API_CANARY_STARTED: "Invio pilota Aruba avviato",
  ARUBA_API_CANARY_SUBMITTED: "Invio pilota Aruba accettato",
  ARUBA_API_CANARY_FAILED: "Invio pilota Aruba non riuscito",
  ARUBA_API_CANARY_UNKNOWN: "Invio pilota Aruba con esito remoto incerto",
  ARUBA_API_CANARY_READBACK: "Invio pilota Aruba riconciliato",
