export const arubaSettingsCopy = {
  ...
  arubaApiTitle: "Connessione API in entrata",
  ...
  arubaApiUsername: "Nome utente API Aruba",
  arubaApiPassword: "Password API Aruba",
  arubaApiExpectedTaxId: "P.IVA o codice fiscale atteso",
  arubaApiSaveCredentials: "Verifica e salva credenziale",
  arubaApiRotateCredentials: "Verifica e ruota credenziale",
  ...
  arubaApiAuthority: "Fonte automatica",
  arubaApiAuthorityBrowser: "Preferito/bridge",
  arubaApiAuthorityApi: "API Aruba",
  arubaApiParity: "Parità con il readback browser",
