-- Rilegge una sola volta gli ordini eBay con la riconciliazione che distingue
-- il netto venditore dal totale cliente. Il margine protegge il limite inferiore.
