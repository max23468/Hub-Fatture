-- Rilegge una sola volta gli ordini eBay già osservati. Il mapper può completare
-- nome e cognome controverificati dal CF e l'import può chiudere i conflitti limitati
-- all'e-mail. Il margine protegge il limite inferiore della finestra.
