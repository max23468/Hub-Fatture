-- Rilegge una sola volta gli ordini Shopify dopo la correzione dei fallback fiscali e
-- dell'indirizzo. Il replay dello stesso payload è riconosciuto dall'import e riallinea
-- atomicamente le preparazioni singole ancora da verificare.
